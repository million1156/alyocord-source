...
if (!isset($_SESSION['loggedin']))
{
  ...
  echo("<script> window.location.href = '//alyocord.funwithalbi.xyz/login/?to=$thing' </script>");
}
...
<head>
  ...
  <meta content="https://alyocord.funwithalbi.xyz/gift?code=<?php echo isset($_GET['code']) ? $_GET['code'] : "123"; ?>" property="og:url" />
